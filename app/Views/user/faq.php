...
<div class="container mt-5">
    <div class="card">
        ...
        <div class="accordion" id="accordionPanelsStayOpenExample">
            <div class="accordion-item">
                ...
                <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                    <div class="accordion-body">
                        Biaya yang kita keluarkan perkantong darah sebenarnya adalah biaya penggantian pemeliharaan darah, supaya kondisinya tetap sama seperti saat berada dalam tubuh kita. Biaya ini yang kita kenal dgn nama <strong>"BPPD"</strong> atau Biaya Penggantian Pengelolaan Darah.
                    </div>
                </div>
            </div>
            <div class="accordion-item">
                ...
                <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwo">
                    <div class="accordion-body">
                        <strong>Kebutuhan yang besar :</strong> Setiap delapan detik, ada satu orang yang membutuhkan transfusi darah di Indonesia. <br>
                        <strong>Pemeriksaan kesehatan gratis :</strong> Sebelum mendonorkan darah, petugas akan memeriksa suhu tubuh, denyut nadi, tekanan darah dan kadar hemoglobin Anda. <br>
                        <strong>Tidak menyakitkan :</strong> Ya Anda memang akan merasa sakit. Namun, rasa sakit itu tidak seberapa dan akan hilang dengan cepat.
                    </div>
                </div>
            </div>
            <div class="accordion-item">
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="panelsStayOpen-headingnine">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapsenine" aria-expanded="false" aria-controls="panelsStayOpen-collapsenine">
                        Apakah Donor Trombosit Apheresis ?
                    </button>
                </h2>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="panelsStayOpen-headingten">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseten" aria-expanded="false" aria-controls="panelsStayOpen-collapseten">
                        Apa yang disebut trombosit (platelet) ?
                    </button>
                </h2>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="panelsStayOpen-headingtwelve">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapsetwelve" aria-expanded="false" aria-controls="panelsStayOpen-collapsetwelve">
                        Adakah persyaratan khusus untuk menjadi donor trombosit apheresis ?
                    </button>
                </h2>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="panelsStayOpen-headingtigabelas">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapsetigabelas" aria-expanded="false" aria-controls="panelsStayOpen-collapsetigabelas">
                        Apakah keuntungan bagi pendonor trombosit apheresis ?
                    </button>
                </h2>
                <div id="panelsStayOpen-collapsetigabelas" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingtigabelas">
                    <div class="accordion-body">
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="panelsStayOpen-headingempatbelas">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseempatbelas" aria-expanded="false" aria-controls="panelsStayOpen-collapseempatbelas">
                        Bagaimana teknik donor trombosit berlangsung ?
                    </button>
                </h2>
                <div id="panelsStayOpen-collapseempatbelas" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingempatbelas">
                    <div class="accordion-body">
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="panelsStayOpen-headinglimabelas">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapselimabelas" aria-expanded="false" aria-controls="panelsStayOpen-collapselimabelas">
                        Apakah keuntungan bagi pasien penerima trombosit apheresis?
                    </button>
                </h2>
                <div id="panelsStayOpen-collapselimabelas" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headinglimabelas">
                    <div class="accordion-body">
